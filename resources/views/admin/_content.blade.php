<div id="page-wrapper" >
    <div id="page-inner">
        <div class="row">
            <div class="col-md-12">
                <h2>Yönetici Gösterge Tablosu</h2>
                <h5>{{\Illuminate\Support\Facades\Auth::user()->name}} , seni tekrar görmek güzel. </h5>
            </div>
        </div>
        <!-- /. ROW  -->
        <hr />
                        ...
                        <ul class="chat-box">
                            <li class="left clearfix">
                                    <span class="chat-img pull-left">
                                        <img src="{{asset('assetsdash')}}/img/1.png" alt="User" class="img-circle" />
                                    </span>
                                <div class="chat-body">
                            ...
                            <li class="right clearfix">
                                    <span class="chat-img pull-right">
                                        ...
                                        <img src="{{asset('assetsdash')}}/img/2.png" alt="User" class="img-circle" />
                                    </span>
                            ...
                            <li class="left clearfix">
                                    <span class="chat-img pull-left">
                                         <img src="{{asset('assetsdash')}}/img/3.png" alt="User" class="img-circle" />
                                    </span>
                                <div class="chat-body clearfix">
                            ...
                            <li class="right clearfix">
                                    <span class="chat-img pull-right">
                                         <img src="{{asset('assetsdash')}}/img/4.png" alt="User" class="img-circle" />
                                    </span>
                                <div class="chat-body clearfix">
